...
var Alert = function Alert(_ref) {
  var msgs = _ref.msgs,
      type = _ref.type;
  return msgs.length !== 0 ? (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
...
/***/ "./resources/js/components/Csrf.js":
/*!*****************************************!*\
  !*** ./resources/js/components/Csrf.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Input = function Input(props) {
  var id = props.id,
      ...
      rest = _objectWithoutProperties(props, ["id", "type", "className", "name", "placeholder", "onChange", "children"]);
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(preact__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("label", {
    "for": id
  }, children), (0,preact__WEBPACK_IMPORTED_MODULE_0__.h)("input", _extends({
    "class": classes,
    id: id,
    type: type,
    name: name,
...
/***/ "./resources/js/components/Method.js":
/*!*******************************************!*\
  !*** ./resources/js/components/Method.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/renderComponent.js":
/*!*****************************************!*\
  !*** ./resources/js/renderComponent.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var bindComponent = function bindComponent(container, Component) {
  var element = document.getElementById("rct-".concat(container));

  if (element) {
    if (element.dataset.props) {
      var props = JSON.parse(element.dataset.props);
      delete element.dataset.props;
      (0,preact__WEBPACK_IMPORTED_MODULE_0__.render)((0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Component, props), element);
    } else {
      (0,preact__WEBPACK_IMPORTED_MODULE_0__.render)((0,preact__WEBPACK_IMPORTED_MODULE_0__.h)(Component, null), element);
    }
  }
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (bindComponent);
...
/* harmony import */ var _components_Csrf__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/Csrf */ "./resources/js/components/Csrf.js");
/* harmony import */ var _components_Method__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/Method */ "./resources/js/components/Method.js");
...
/* harmony import */ var _components_Input__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/Input */ "./resources/js/components/Input.js");
...
/* harmony import */ var _renderComponent__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../renderComponent */ "./resources/js/renderComponent.js");
...
var Login = function Login(_ref) {
  var csrf = _ref.csrf,
      ...
      authGoogle = _ref.authGoogle,
      authFacebook = _ref.authFacebook,
      auth = _ref.auth;
  ...
  var _useState5 = (0,preact_hooks__WEBPACK_IMPORTED_MODULE_2__.useState)([]),
      ...
      responces = _useState6[0],
      setResponces = _useState6[1];
          ...
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (validInputs(data)) {
                ...
                axios__WEBPACK_IMPORTED_MODULE_3___default().post(action, login).then(function (res) {
                  console.log(res);
                  console.log("logged");
                  ...
                  if (err.response && "errors" in err.response.data) {
                    (function () {
                      ...
                      for (var _e2 in errors) {
                        errors[_e2].forEach(function (er) {
                          return errs.push(er);
                        });
                      }
  ...
  var validInputs = function validInputs(data) {
    ...
    if (email === "") {
      ...
      setLoading(false);
      return false;
    } else if (!_utils__WEBPACK_IMPORTED_MODULE_9__.validate.Email(email)) {
  ...
  var onChange = function onChange(e) {
    return setData(function (state) {
      if (e.target.type === "checkbox") {
        return _objectSpread(_objectSpread({}, state), {}, _defineProperty({}, e.target.name, e.target.checked));
      }
  ...
  return (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Alert__WEBPACK_IMPORTED_MODULE_6__.Errors, {
    errors: errors
  }), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Alert__WEBPACK_IMPORTED_MODULE_6__.Success, {
    responces: responces
    ...
    action: action,
    onSubmit: onSubmit
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Csrf__WEBPACK_IMPORTED_MODULE_4__.default, {
    csrf: csrf
  }), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Method__WEBPACK_IMPORTED_MODULE_5__.default, {
    name: "POST"
  }), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    className: "form-row"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    "class": "col-md-6"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Input__WEBPACK_IMPORTED_MODULE_7__.Input, {
    id: "emailL",
    type: "email",
    name: "email",
    placeholder: "E-mail",
    onChange: onChange
  }, "E-mail")), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    "class": "col-md-6"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Input__WEBPACK_IMPORTED_MODULE_7__.Input, {
    id: "passwordL",
    type: "password",
    ...
    onChange: onChange
  }, "Password")), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    "class": "col-md-12"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Input__WEBPACK_IMPORTED_MODULE_7__.CheckBox, {
    id: "idKeepMeSignedIn",
    name: "keepMeSignedIn",
    ...
    "class": "col-md-12"
  }, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)(_components_Button__WEBPACK_IMPORTED_MODULE_8__.Button, {
    title: "login",
    isLoading: loading
  })), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    "class": "col-md-12 mt-2"
  }, !auth && (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("p", null, "Don't have an Account? ", (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
    href: register
  }, "Register")), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("p", null, (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
    "class": "btn btn-primary",
    href: authFacebook
  }, "Login with Facebook"), (0,preact__WEBPACK_IMPORTED_MODULE_1__.h)("a", {
...
(0,_renderComponent__WEBPACK_IMPORTED_MODULE_10__.default)('login', Login);

/***/ }),

/***/ "./resources/js/utils/classCss.js":
/*!****************************************!*\
  !*** ./resources/js/utils/classCss.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
var className = function className(name, classes) {
...
/* harmony export */   "classCss": () => (/* reexport module object */ _classCss__WEBPACK_IMPORTED_MODULE_1__)
/* harmony export */ });
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validate */ "./resources/js/utils/validate.js");
/* harmony import */ var _classCss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classCss */ "./resources/js/utils/classCss.js");
...
/* harmony export */   "mobileNumber": () => (/* binding */ mobileNumber)
/* harmony export */ });
var Email = function Email(email) {
  var re = /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
  return re.test(String(email).toLowerCase());
};
var mobileNumber = function mobileNumber(mobile) {
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./resources/js/screens/login.js");
